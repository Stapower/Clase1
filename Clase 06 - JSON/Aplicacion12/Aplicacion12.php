<html>
	<head>
		<title>Aplicaci&oacute;n 12</title>
		...
		<script type="text/javascript">
			function TraerCiudades()
			{
				...
				.done(function(resultado)
				{
					...
					var tabla = "<table><th><td>Id</td><td>Nombre</td><td>Country</td><td>Coord lon</td><td>Coord lat</td><td>Accion</td></th>";
					for (var i = 0; i < listaCiudadesJson.length; i++)
					{
						...
						+listaCiudadesJson[i].coord.lat+"</td><td>"
						+"<a id=\""+listaCiudadesJson[i]["_id"]+"\">Eliminar</a></td></tr>";
					}
					tabla += "</table>";
					$(tabla).appendTo("body");
					// Ó
